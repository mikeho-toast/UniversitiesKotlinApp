...
class RecyclerAdapter(
    private val universityNames: List<University>,
    private val clickListener: (University) -> Unit
) : RecyclerView.Adapter<RecyclerAdapter.UniversityViewHolder>() {

    /**
     * Inflates individually item views from their corresponding XML
     */
    ...
    /**
     * Asks for the number of items that will be displayed
     */
    override fun getItemCount() = universityNames.size

    class UniversityViewHolder(itemView: View, private val clickListener: (University) -> Unit) :
        ...
        fun bind(universityName: University) { //binds the text of the view to the textView associated with a single university
            ...
            this.universityName =
                universityName //this is referring to private lateinit var universityName: University and universityName is (universityName: University)
        }
    }
}
